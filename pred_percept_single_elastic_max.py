...
for i in range(the_df.shape[0]):
    ...
    mixture_all += [(np.max(feature_all,axis=0)).tolist()]
...
df_mixture.to_csv(path0 + 'percept_mixture_max_snitz1.csv')
...
df_mixture.columns = df_percept.columns
df_mixture.index = the_df.index
df_mixture.to_csv(path0 + 'percept_mixture_max_snitz2.csv')
...
df_mixture.columns = df_percept.columns
df_mixture.index = the_df.index
df_mixture.to_csv(path0 + 'percept_mixture_max_bushdid.csv')
...
df_mixture.columns = df_percept.columns
df_mixture.index = the_df.index
df_mixture.to_csv(path0 + 'percept_mixture_max_ravia.csv')
